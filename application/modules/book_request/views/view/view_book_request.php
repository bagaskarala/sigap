        ...
        <ul class="nav nav-tabs card-header-tabs">
            <li class="nav-item">
                <a
                    ...
                    data-toggle="tab"
                    href="#book-request-data-wrapper"
                ><i class="fa fa-info-circle"></i> Detail Pesanan Buku</a>
            </li>
        </ul>
    </header>
...
<?php elseif ($level == 'superadmin' || $level == 'admin_gudang') : ?>
    <section
        id="preparing-progress-wrapper"
        class="card"
    >
...
function generate_pdf() {
    const pdfUrl = "<?= base_url("invoice/generate_pdf/{$book_request->type}/{$book_request->invoice_id}"); ?>"
