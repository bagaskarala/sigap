...
$stock_lesseq       = $this->input->get('stock_lesseq') ? $this->input->get('stock_lesseq') : '';
$stock_moreeq       = $this->input->get('stock_moreeq') ? $this->input->get('stock_moreeq') : '';
                            ...
                            <div class="col-12 col-lg-6">
                                ...
                                >
                                    ...
                                    <?php if ($level == "superadmin" || $level == "admin_gudang" || $level == "admin_pemasaran") : ?>
                                        ...
                                        ><i class="fas fa-file-excel mr-2"></i>Stok
                                            Buku</button>
                                        <button
                                            class="btn btn-success col-3"
                                            id="excel"
                                ...
                                <tbody>
                                    <?php foreach ($book_stocks as $book_stock) : ?>
                                        <tr>
                                            ...
                                            <td class="align-middle text-center">
                                                <a
                                                    ...
                                                    data-toggle="modal"
                                                    data-target="#modal-edit-rak-<?= $book_stock->book_stock_id; ?>"
                                                >
                                                    <span><?= $book_stock->book_location ?? '-'; ?></span>
                                            ...
                                            <td class="align-middle text-center">
                                                <a
                                                    href="<?= base_url('book_stock/retur/' . $book_stock->book_stock_id); ?>"
                                                    title="Revisi Stok Retur"
                                                >
                                                    <span><?= $book_stock->retur_stock ?? '-'; ?></span>
                                                    <i class="fa fa-pencil-alt ml-1"></i>
                                                </a>
                                            </td>
                                            <?php if ($level == 'superadmin' || $level == 'admin_gudang') : ?>
                                                <td class="align-middle text-center">
                                                    <div class="text-right">
                                                        <a
                                                            href="<?= base_url('book_stock/edit/' . $book_stock->book_stock_id); ?>"
                                        ...
                                        <div
                                            ...
                                            id="modal-edit-rak-<?= $book_stock->book_stock_id; ?>"
                                            tabindex="-1"
                                            role="dialog"
                                            aria-labelledby="modal-edit-rak-<?= $book_stock->book_stock_id; ?>"
                                            aria-hidden="true"
                                        >
                                            <div
                                                class="modal-dialog"
