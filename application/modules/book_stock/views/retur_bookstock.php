            ...
            <div class="card">
                <div class="card-body">
                    <fieldset>
                        ...
                        <form
                            action="<?= base_url('book_stock/retur_book_stock/'); ?>"
                            method="post"
                        >
                            ...
                            >
                                ...
                                > Tipe Retur <abbr title="Required">*</abbr></label>
                                <div
                            ...
                            >
                                <label
                                    for="revision_date"
                                    class="d-block font-weight-bold"
                                >Tanggal Retur <abbr title="Required">*</abbr> </label>
                            ...
                            <div class="form-group">
                                <label
                                    class="font-weight-bold"
                                    for="notes"
                                >Catatan<abbr title="Required">*</abbr></label>
                                <textarea
                                    required
                                    rows="6"
